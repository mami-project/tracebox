...
#define WARTS_TRACEBOX_RTT                  10 
#define WARTS_TRACEBOX_ICMP_QUOTE_TYPE      11
#define WARTS_TRACEBOX_UDP                  12
#define WARTS_TRACEBOX_PRINTMODE            13 
#define WARTS_TRACEBOX_PRINT_VALUE          14
#define WARTS_TRACEBOX_PKTC16               15
#define WARTS_TRACEBOX_PKTC                 16
...
static const warts_var_t tracebox_vars[] =
  {
    ...
    {WARTS_TRACEBOX_RTT,                   1, -1},
    {WARTS_TRACEBOX_ICMP_QUOTE_TYPE,       1, -1},
    {WARTS_TRACEBOX_UDP,                   1, -1},
    {WARTS_TRACEBOX_PRINTMODE,             1, -1},
    {WARTS_TRACEBOX_PRINT_VALUE,           1, -1},
				      ...
				      uint8_t *buf, uint32_t *off, uint32_t len)
{
  ...
  warts_param_reader_t handlers[] = {
    ...
    {&tracebox->rtt,                (wpr_t)extract_byte,    NULL},
    {&tracebox->icmp_quote_type,    (wpr_t)extract_byte,    NULL},
    {&tracebox->udp,                (wpr_t)extract_byte,    NULL},
    {&tracebox->printmode,          (wpr_t)extract_byte,    NULL},
    {&tracebox->print_values,       (wpr_t)extract_byte,    NULL},
				       ...
				       const uint16_t params_len)
{
  ...
  warts_param_writer_t handlers[] = {
    ...
    {&tracebox->rtt,                (wpw_t)insert_byte,    NULL},
